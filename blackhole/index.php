...
define('BLACKHOLE_TO',      'r.vgastel@kpnmail.nl'); // email to
define('BLACKHOLE_FROM',    'r.vgastel@kpnmail.nl'); // email from
define('BLACKHOLE_SUBJECT', 'Bad Bot Alert! for NZBstars.com');    // email subject
